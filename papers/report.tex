...
The first half of a MAC address (ie. the first 32 bits) are known as the organisationally unique identifier (OUI). 



Malware families like Mirai, IoT Reaper, and Mozi have taken advantage of lax IoT security to recruit hosts for botnets, with Mirai in particular amassing enough bots to generate over 1TB/s of traffic used for distributed denial of service attacks (DDoS).
...
this was caused by a buggy implementation of Mirai which deactivated routers instead of using them to contribute to DDoS attacks.
